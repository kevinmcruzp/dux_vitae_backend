/*
  ...
  - Added the required column `clientRut` to the `appointments` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_appointments" ("created_at", "idAppointment", "message", "nutritionistRut", "title", "updated_at") SELECT "created_at", "idAppointment", "message", "nutritionistRut", "title", "updated_at" FROM "appointments";
